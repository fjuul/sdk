...
public class GHCHeartRateDataPoint extends GHCScalarDataPoint<Float> {
    public GHCHeartRateDataPoint(@NonNull Float value, @NonNull Date start, @NonNull String dataSource) {
    ...
    public String toString() {
        ...
        return String.format(Locale
            .getDefault(), "GHCHRDataPoint: bpm %f, start %s, dataSource %s", value, startFormatted, dataSource);
    }
}
