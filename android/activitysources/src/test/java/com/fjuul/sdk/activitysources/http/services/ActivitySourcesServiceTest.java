...
public class ActivitySourcesServiceTest {
    ...
    public static class ConnectToTracker extends GivenRobolectricContext {
        ...
        @Test
        public void connect_WithHttpOkResponseCode_RespondWithExternalAuthenticationFlow() throws IOException, InterruptedException {
            ...
            ExternalAuthenticationFlowRequired trackerAuthentication = (ExternalAuthenticationFlowRequired) result.getValue();
            assertEquals("should have auth url", "https://connect.garmin.com/oauthConfirm?oauth_token=9be0741a", trackerAuthentication.getUrl());
        }
