...
public class GFUploadDataJsonAdapterTest {
    ...
    public static class ToJson extends GivenRobolectricContext {
        ...
        public static final List<GFHRSummaryDataPoint> intradayHeartRateSummary = Arrays.asList(
            new GFHRSummaryDataPoint(74.53277f, 74f, 76f, Date.from(Instant.parse("2020-01-14T23:00:00.000Z")), "raw:com.google.heart_rate.bpm:com.mc.miband1"),
            new GFHRSummaryDataPoint(73.88201f, 71f, 76f, Date.from(Instant.parse("2020-01-14T23:01:00.000Z")), "raw:com.google.heart_rate.bpm:com.mc.miband1"),
            new GFHRSummaryDataPoint(64f, 64f, 64f, Date.from(Instant.parse("2020-01-14T23:02:00.000Z")), "raw:com.google.heart_rate.bpm:com.mc.miband2"),
            new GFHRSummaryDataPoint(64.37467f, 63f, 65f, Date.from(Instant.parse("2020-01-14T23:03:00.000Z")), "raw:com.google.heart_rate.bpm:com.mc.miband2")
        );
        ...
        public void toJson_whenOnlySessionsData_serializeOnlySessions() {
            List<GFSessionBundle> sessions = Arrays.asList(
                new GFSessionBundle.Builder()
                    .setId("123")
                    .setName("nice-ride")
