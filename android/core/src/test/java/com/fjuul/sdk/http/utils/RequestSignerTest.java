...
public class RequestSignerTest {
    ...
    public static class RequestWithoutDigestTest {
        ...
        @Test
        public void signRequest_WithGetMethodAndQueryParamsAndHash_returnsSignedRequest() throws InterruptedException {
            Request.Builder testRequestBuilder = new Request.Builder();
            Request testRequest =
                testRequestBuilder
                    .url(
    ...
    public static class RequestWithDigestTest {
        ...
        @Test
        public void signRequest_PostWithoutRequestBody_returnsSignedRequest()
        ...
        @Test
        public void signRequest_PostWithJsonRequestBody_returnsSignedRequest()
                throws InterruptedException {
            Request.Builder testRequestBuilder = new Request.Builder();
            Request testRequest =
                    testRequestBuilder
