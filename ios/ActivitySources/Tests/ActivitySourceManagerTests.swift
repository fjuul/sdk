...
//    static func reset() {
//        current.apiClient = nil
//        current.mountedActivitySourceConnections = []
//        current.config = nil
//    }
}
...
//
//class ApiClientStub: ApiClient {
////    override var activitySources: ActivitySourcesApi =
//
//    override func connect(activitySourceItem: ActivitySourcesItem, completion: @escaping (Result<ConnectionResult, Error>) -> Void) {
...
class ActivitySourcesApiStub: ActivitySourcesApi {
    override func connect(activitySourceItem: ActivitySourcesItem, completion: @escaping (Result<ConnectionResult, Error>) -> Void) {
        let trackerConnection = TrackerConnection(id: "0ca60422-3626-4b50-aa70-43c91d8da731", tracker: "polar", createdAt: Date(), endedAt: nil)

        completion(.success(.connected(trackerConnection: trackerConnection)))
    }
    
    override func getCurrentConnections(completion: @escaping (Result<[TrackerConnection], Error>) -> Void) {
        let trackerConnection = TrackerConnection(id: "0ca60422-3626-4b50-aa70-43c91d8da731", tracker: "polar", createdAt: Date(), endedAt: nil)
...
final class ActivitySourceManagerTests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
//        sut = ActivitySourceManager.current
    }
...
//
//        // When
//        let sut = ActivitySourceManager.initialize(apiClient: client, config: config)
//
//        // Then
