...
public class ActivitySourceResolver {
    ...
    public ActivitySource getInstanceByTrackerValue(@NonNull String trackerValue) {
        ...
        } else if (TrackerValue.OURA.equals(tracker)) {
            return OuraActivitySource.getInstance();
        ...
        } else if (TrackerValue.GOOGLE_HEALTH_CONNECT.equals(tracker)) {
            return GoogleHealthConnectActivitySource.getInstance();
        }
