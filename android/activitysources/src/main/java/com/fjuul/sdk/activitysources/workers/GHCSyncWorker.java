...
public abstract class GHCSyncWorker extends Worker {
    ...
    protected ActivitySourcesManager getOrInitializeActivitySourcesManager() {
        ...
        try {
            ...
            // previously scheduled periodic Google Health Connect sync works.
    ...
    @SuppressLint("NewApi")
    @Nullable
    protected static ActivitySourceConnection getGoogleHealthConnectActivitySourceConnection(
